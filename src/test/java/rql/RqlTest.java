...
public class RqlTest
{
	...
	public static void render(String template, Map<String, ?> variables, String expected) throws RqlException
	{
	...
	private static String buildTemplate(String template, Map<String,?> variables) throws RqlException
	{
